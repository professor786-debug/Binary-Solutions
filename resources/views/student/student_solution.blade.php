                                        ...
                                        @forelse($purchases as $purchase)
                                            <tr>
                                                ...
                                                @php
                                                    ...
                                                    $addonIcons = [
                                                        'video_demo' => '<i class="fas fa-video"></i> Video Demo',
                                                        'walkthrough_pdf' =>
                                                            '<i class="fas fa-file-pdf"></i> Walkthrough PDF',
                                                        'report_path' => '<i class="fas fa-file-alt"></i> Final Report',
                                                        'source_code' => '<i class="fas fa-code"></i> Source Code',
                                                    ];
                                                @endphp
