...
<head>
    ...
    <style>
        ...
        @media(max-width:829px) and (min-width:576px) {
            .butns-seting {
                display: flex;
                gap: 5px
            }
            ...
            <div class="main-content">
                ...
                <div class="modal fade" id="priceModal-{{ $solution->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <form action="{{ route('admin.custom-solutions.set-price', $solution->id) }}" method="POST">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="priceModalLabel-{{ $solution->id }}">Set Price for
                                        Solution #{{ $solution->id }}</h5>
