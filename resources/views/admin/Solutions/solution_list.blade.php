                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Solutions</h4>
                                        <a href="{{ route('solutions.create') }}" class="btn btn-primary">Add
                                            Solution</a>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    @foreach ($solutions as $index => $solution)
                                                        <tr>
                                                            ...
                                                            <td>{{ $solution->subject_area }}</td>
                                                            <td>{{ number_format($solution->price) }}</td>
                                                            <td>
                                                                <span
                                                                    class="badge badge-{{ $solution->status === 'Published' ? 'success' : 'warning' }}">
                                                                    {{ $solution->status }}
                                                                </span>
                                                            </td>
